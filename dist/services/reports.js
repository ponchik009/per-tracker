...
exports.buildEventsReport = exports.buildWeightReport = void 0;
const XLSX = __importStar(require("xlsx"));
const buildWeightReport = (rows) => {
    const wb = XLSX.utils.book_new();
    const sheet = XLSX.utils.json_to_sheet(rows);
    XLSX.utils.book_append_sheet(wb, sheet, "Вес");
    return XLSX.write(wb, { type: "buffer", bookType: "xlsx" });
};
exports.buildWeightReport = buildWeightReport;
const buildEventsReport = (petName, weights, events, feedings) => {
    const wb = XLSX.utils.book_new();
...
exports.buildEventsReport = buildEventsReport;
